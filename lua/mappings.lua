...
map({'n', 't'}, '<C-J>', "<C-w>j", { desc = "switch window right" })
map({'n', 't'}, '<C-K>', "<C-w>k", { desc = "switch window up" })
map({'n', 't'}, '<C-L>', "<C-w>l", { desc = "switch window down" })
...
map("n", "<leader>fm", builtin.git_commits, { desc = "Open Telescope to list git commits" })
-- NvimTree
